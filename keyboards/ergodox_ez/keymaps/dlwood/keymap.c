...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // -------   -------   -------   -------  -------  -------                -------
     ...
     _______,  KC_N,     KC_M,     KC_COMM, KC_DOT,  MT(MOD_RCTL, KC_SLSH), KC_RSFT,
                         TT(NUM_), KC_RALT, KC_RALT, _______,               TT(FUN_),
     _______,  MO(DBG_),
     _______,
  ...
  // -------  -------  -------  -------  -------      -------  -------
     ...
     _______, _______, XXXXXXX, XXXXXXX, KC_NUM_EXIT,
                                                      _______, _______,
                                                               _______,
  ...
  // -------  -------  -------      -------  -------  -------  -------
     ...
     _______, KC_RPRN, KC_RPRN,     KC_COMM, KC_DOT,  KC_SLSH, KC_PPLS,
                       KC_NUM_EXIT, _______, _______, _______, _______,
     _______, _______,
     _______,
     _______, _______, _______
  ),
  ...
  // -------  -------  -------  -------  -------  -------  -------
     _______, _______, _______, _______, _______, _______, _______,
     _______, KC_PPLS, KC_LBRC, KC_COLN, KC_RBRC, KC_PIPE, _______,
              KC_QUOT, KC_LPRN, KC_DQUO, KC_RPRN, KC_BSLS, KC_EQL,
     _______, KC_MINS, KC_LCBR, KC_UNDS, KC_RCBR, KC_TILD, KC_GRV,
                       _______, _______, _______, _______, _______,
     _______, _______,
     _______,
     _______, _______, _______
